...
OBJ = omega.o abyss.o aux1.o aux2.o aux3.o bank.o character.o city.o\
      ...
      effect2.o effect3.o etc.o env.o file.o functions.o gen1.o gen2.o guild1.o guild2.o\
      house.o init.o inventory.o item.o itemf1.o itemf2.o itemf3.o level.o lua_functions.o map.o\
