...
static int user_character_dance (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Can you dance? [yn] "))
    {
        return 0;
    }

    if ('y' != cinema_ynq_line(1, "Well? [yn] "))
    {
        return 1;
    }
...
static int user_character_martial_art (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Do you have training in a martial art or gymnastics? [yn] "))
    {
        return 0;
    }

    if ('y' != cinema_ynq_line(1, "Do you have dan rank or equivalent? [yn] "))
    {
        return 2;
    }
...
static int user_character_field_sport (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Do you play some field sport? [yn] "))
    {
        return 0;
    }

    if ('y' != cinema_ynq_line(1, "Are you good? [yn] "))
    {
        return 1;
    }
...
static int user_character_cave (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Do you cave, mountaineer, etc.? [yn] "))
    {
        return 0;
    }
...
static int user_character_skate (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Do you skate or ski? [yn] "))
    {
        return 0;
    }
...
static int user_character_handicapped (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Are you physically handicapped? [yn] "))
    {
        return 0;
    }
...
static int user_character_accident_prone (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Are you accident prone? [yn] "))
    {
        return 0;
    }
...
static int user_character_bicycle (void)
{
    ...
    if ('y' == cinema_ynq_line(0, "Can you ride a bicycle? [yn] "))
    {
        return 0;
    }
...
static int user_character_video_games (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Do you play video games? [yn] "))
    {
        return 0;
    }

    if ('y' != cinema_ynq_line(1, "Do you get high scores? [yn] "))
    {
        return 2;
    }
...
static int user_character_archer (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Are you an archer, fencer, or marksman? [yn] "))
    {
        return 0;
    }
...
static int user_character_picked_lock (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Have you ever picked a lock? [yn] "))
    {
        return 0;
    }
...
static int user_character_hand_shakes (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Hold your arm out. Tense your fist. Hand shaking? [yn] "))
    {
        return 0;
    }
...
static int user_character_ambidextrous (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Ambidextrous, are you? [yn] "))
    {
        return 0;
    }
...
static int user_character_can_cut_deck (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Can you cut a deck of cards with one hand? [yn] "))
    {
        return 0;
    }
...
static int user_character_can_tie_shoes (void)
{
    ...
    if ('y' == cinema_ynq_line(0, "Can you tie your shoes blindfolded? [yn] "))
    {
        return 0;
    }
...
static int user_character_colds (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Do you ever get colds? [yn] "))
    {
        return 4;
    }

    if ('y' != cinema_ynq_line(1, "Frequently? [yn] "))
    {
        return 0;
    }
...
static int user_character_recent_accident (void)
{
    ...
    if ('y' == cinema_ynq_line(0, "Had any serious accident or illness this year? [yn] "))
    {
        return -4;
    }
...
static int user_character_chronic_disease (void)
{
    ...
    if ('y' == cinema_ynq_line(0, "Have a chronic disease? [yn] "))
    {
        return -4;
    }
...
static int user_character_overweight (void)
{
    ...
    if ('y' == cinema_ynq_line(0, "Overweight or underweight by more than 20 percent? [yn] "))
    {
        return -2;
    }
...
static int user_character_high_blood_pressure (void)
{
    ...
    if ('y' == cinema_ynq_line(0, "High blood pressure? [yn] "))
    {
        return -2;
    }
...
static int user_character_smoke (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Do you smoke? [yn] "))
    {
        return 0;
    }
...
static int user_character_aerobics (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Take aerobics classes? [yn] "))
    {
        return 0;
    }
...
static int user_character_animals (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Do animals react oddly to your presence? [yn] "))
    {
        return 0;
    }
...
static int user_character_auras (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Can you see auras? [yn] "))
    {
        return 0;
    }
...
static int user_character_out_of_body (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Ever have an out-of-body experience? [yn] "))
    {
        return 0;
    }
...
static int user_character_spell (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Did you ever cast a spell? [yn] "))
    {
        return 0;
    }

    if ('y' != cinema_ynq_line(1, "Did it work? [yn] "))
    {
        return 3;
    }
...
static int user_character_esp (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Do you have ESP? [yn] "))
    {
        return 0;
    }
...
static int user_character_pk (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Do you have PK? [yn] "))
    {
        return 0;
    }
...
static int user_character_ghosts (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Do you believe in ghosts? [yn] "))
    {
        return 0;
    }
...
static int user_character_irish (void)
{
    ...
    if ('y' != cinema_ynq_line(0, "Are you Irish? [yn] "))
    {
        return 0;
    }
